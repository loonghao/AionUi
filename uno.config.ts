...
export default defineConfig({
  ...
  rules: [
    ...
    [
      /^bg-fill-([1-4])$/,
      ([, d]: RegExpExecArray) => ({ "background-color": `var(--color-fill-${d})` }),
    ],
    ...
    [
      /^border-arco-([1-4])$/,
      ([, d]: RegExpExecArray) => ({ "border-color": `var(--color-border-${d})` }),
    ],
    ...
    [
      ...
      ([, color, d]: RegExpExecArray) => ({
        "background-color": `var(--color-${color}-light-${d})`,
      }),
    ],
