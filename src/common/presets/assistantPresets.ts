...
export const ASSISTANT_PRESETS: AssistantPreset[] = [
  {
    ...
    descriptionI18n: {
      ...
      "zh-CN":
        "OpenClaw 安装、部署、配置和故障排查专家。主动协助设置、诊断问题并提供安全最佳实践。",
    },
    promptsI18n: {
      "en-US": [
  ...
  },
  {
    ...
    descriptionI18n: {
      "en-US":
        "Autonomous task execution with file operations, document processing, and multi-step workflow planning.",
  ...
  },
  {
    ...
    descriptionI18n: {
      ...
      "zh-CN":
        "专业 UI/UX 设计智能助手，包含 57 种风格、95 个配色方案、56 个字体配对及技术栈最佳实践。",
    },
    promptsI18n: {
      "en-US": [
  ...
  },
  {
    ...
    descriptionI18n: {
      ...
      "zh-CN":
        "Manus 风格的文件规划，用于复杂任务。使用 task_plan.md、findings.md 和 progress.md 维护持久化上下文。",
    },
    promptsI18n: {
      "en-US": [
  ...
  },
  {
    ...
    descriptionI18n: {
      ...
      "zh-CN":
        "基于 HUMAN 3.0 框架的个人发展教练：4 象限（思维/身体/精神/职业）、3 层次、3 成长阶段。",
    },
    promptsI18n: {
      "en-US": [
  ...
  },
  {
    ...
    descriptionI18n: {
      "en-US":
        "Expand hiring requests into a full JD, images, and publish to social platforms via connectors.",
