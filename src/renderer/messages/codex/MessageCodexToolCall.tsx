...
>;
type WebSearchContent = Extract<
  CodexToolCallUpdate,
  { subtype: "web_search_begin" | "web_search_end" }
>;
type PatchContent = Extract<
  CodexToolCallUpdate,
  { subtype: "patch_apply_begin" | "patch_apply_end" }
>;
type McpToolContent = Extract<
  CodexToolCallUpdate,
  { subtype: "mcp_tool_call_begin" | "mcp_tool_call_end" }
>;
