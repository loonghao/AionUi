          ...
          <div className="bg-base rounded-lg max-h-[200px] overflow-y-auto">
            {importableServers.map((server, index) => (
              <div
                ...
                className="p-3"
                style={
                  index < importableServers.length - 1
              ...
              >
                ...
                {server.description && (
                  <div className="text-sm text-t-secondary mt-1">{server.description}</div>
                )}
              </div>
            ))}
          </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col h-275px mt-20px">
        ...
        <div
          className={`mb-6 flex-1 overflow-y-auto ${currentStep === 1 ? "min-h-[60px]" : "min-h-[180px]"}`}
        >
