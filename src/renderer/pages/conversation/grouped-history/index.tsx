        ...
        <div className="py-8px">
          <div className="text-14px mb-16px text-t-secondary">
            {exportTask?.mode === "batch"
              ? t("conversation.history.exportDialogBatchDescription", {
                  count: exportTask.conversationIds.length,
                })
              : t("conversation.history.exportDialogSingleDescription")}
          </div>

          <div className="mb-16px p-16px rounded-12px bg-fill-1">
            <div className="text-14px mb-8px text-t-primary">
              {t("conversation.history.exportTargetFolder")}
            </div>
            <div
            ...
            {section.items.map((item) => {
              if (item.type === "workspace" && item.workspaceGroup) {
                ...
                return (
                  <div
                    key={group.workspace}
                    className={classNames("min-w-0", { "px-8px": !collapsed })}
                  >
                    <WorkspaceCollapse
                    ...
                    >
                      <div
                        className={classNames("flex flex-col gap-2px min-w-0", {
                          "mt-4px": !collapsed,
                        })}
                      >
