...
const ConversationRow: React.FC<ConversationRowProps> = (props) => {
  const { conversation, collapsed, tooltipEnabled, batchMode, checked, selected, menuVisible } =
    props;
    ...
    if (assistantInfo) {
      ...
      return (
        <img
          ...
          className="w-20px h-20px rounded-50% flex-shrink-0"
        />
      );
    }
                ...
                >
                  <Menu.Item key="pin">
                    <div className="flex items-center gap-8px">
                      ...
                      <span>
                        {isPinned ? t("conversation.history.unpin") : t("conversation.history.pin")}
                      </span>
                    </div>
                  </Menu.Item>
