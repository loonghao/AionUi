        ...
        <div className="flex items-center h-full gap-8px">
            ...
            <>
              ...
              {!isDiff && (
                <div
                  ...
                  title={
                    isSplitScreenEnabled
                      ? t("preview.closeSplitScreen")
                      : t("preview.openSplitScreen")
                  }
                >
                  <svg
          ...
          {isEditable && isEditMode && (
            <div
              ...
              title={
                isSplitScreenEnabled ? t("preview.closeSplitScreen") : t("preview.openSplitScreen")
              }
            >
              <svg
                width={toolbarIconSize}
        ...
        <div className="flex items-center gap-4px flex-shrink-0">
          ...
          {((contentType === "markdown" && (viewMode === "source" || isSplitScreenEnabled)) ||
            ...
            <>
              <div
                ...
                title={
                  historyTarget ? t("preview.saveSnapshot") : t("preview.snapshotNotSupported")
                }
              >
                <svg
                  width={toolbarIconSize}
          ...
          {isHTML && onInspectModeToggle && (
            <div
              ...
              title={
                inspectMode
                  ? t("preview.html.inspectElementDisable")
                  : t("preview.html.inspectElementEnable")
              }
            >
              <svg
                width={toolbarIconSize}
              ...
              <span>
                {inspectMode ? t("preview.html.inspecting") : t("preview.html.inspectElement")}
              </span>
            </div>
          )}
        </div>
