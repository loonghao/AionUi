...
} from "../../context/PreviewToolbarExtrasContext";
...
const PreviewPanel: React.FC = () => {
  ...
  const hasBuiltInOpenButton = (FILE_TYPES_WITH_BUILTIN_OPEN as readonly string[]).includes(
    contentType,
  );
  ...
  const handleDownload = useCallback(async () => {
    try {
      ...
      if (contentType === "image") {
        ...
        const mimeExt =
          blob.type && blob.type.includes("/") ? blob.type.split("/").pop() : undefined;
