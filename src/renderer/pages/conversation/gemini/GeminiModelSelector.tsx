...
const GeminiModelSelector: React.FC<{
  ...
  const { providers, geminiModeLookup, getAvailableModels, handleSelectModel, formatModelLabel } =
    selection;
  ...
  const label =
    customLabel ||
    (currentModel
      ? formatModelLabel(currentModel, currentModel.useModel)
                          ...
                          <Tooltip
                            ...
                            content={
                              <div className="max-w-240px space-y-6px">
                                <div className="text-12px text-t-tertiary leading-5">
                                  {option.description}
                                </div>
                                {option.modelHint && (
