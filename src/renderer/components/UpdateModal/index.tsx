...
const UpdateModal: React.FC = () => {
  ...
  const includePrerelease = useMemo(
  ...
  useEffect(() => {
    const removeProgressListener = ipcBridge.update.downloadProgress.on(
      (evt: UpdateDownloadProgressEvent) => {
        if (!evt) return;
        ...
        return (
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-between px-24px py-12px bg-fill-1 border-b border-border-2">
              ...
              <Switch
                checked={useAutoUpdate}
                onChange={setUseAutoUpdate}
                size="small"
                disabled={!hasCompatibleManualAsset}
              />
            </div>
      ...
      case "downloading":
        return (
          <div className="flex flex-col items-center justify-center py-48px px-32px">
            ...
            <div className="text-16px text-t-primary font-600 mb-20px">
