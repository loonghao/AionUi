      ...
      if (result.success && result.data?.success) {
        ...
        Message.success(
          t(
            ...
            `Connected! Bot: @${result.data.botUsername || "unknown"}`,
          ),
        );
        ...
        setTokenTested(false);
        Message.error(
          result.data?.error || t("settings.assistant.connectionFailed", "Connection failed"),
        );
      }
    } catch (error: any) {
      setTokenTested(false);
            ...
            >
              <span>
                <Input.Password
                  ...
                  placeholder={
                    authorizedUsers.length > 0 || pluginStatus?.hasToken
                      ? "••••••••••••••••"
                      : "123456:ABC-DEF..."
                  }
                  style={{ width: 240 }}
      ...
      {pluginStatus?.enabled && pluginStatus?.connected && authorizedUsers.length === 0 && (
        <div className="bg-blue-50 dark:bg-blue-900/20 rd-12px p-16px border border-blue-200 dark:border-blue-800">
          ...
          <div className="text-14px text-t-secondary space-y-8px">
            <p className="m-0">
              <strong>1.</strong>{" "}
              {t("settings.assistant.step1", "Open Telegram and search for your bot")}
            ...
            <p className="m-0">
              ...
              {t(
                ...
                "Send any message or click /start to initiate pairing",
              )}
            </p>
            <p className="m-0">
              <strong>3.</strong>{" "}
            ...
            <p className="m-0">
              ...
              {t(
                ...
                "Once approved, you can start chatting with Gemini through Telegram!",
              )}
            </p>
          </div>
        </div>
