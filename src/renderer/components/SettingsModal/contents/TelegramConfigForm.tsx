    ...
    const loadAgentsAndSelection = async () => {
      try {
        ...
        if (agentsResp.success && agentsResp.data) {
          ...
          const list = agentsResp.data.filter((a) => !a.isPreset && CHANNEL_SUPPORTED_BACKENDS.has(a.backend)).map((a) => ({ backend: a.backend, name: a.name, customAgentId: a.customAgentId, isPreset: a.isPreset, isExtension: a.isExtension }));
